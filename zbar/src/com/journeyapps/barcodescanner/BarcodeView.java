...
//            this.decoderThread.setDecoder(createDecoder());
            this.decoderThread.setDecoder(createZbarDecoder());
        }
    }

    private Decoder createZbarDecoder() {
...
//            decoderThread = new DecoderThread(getCameraInstance(), createDecoder(), resultHandler);
            decoderThread = new DecoderThread(getCameraInstance(), createZbarDecoder(), resultHandler);
